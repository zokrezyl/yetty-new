...
typedef struct yetty_ycore_void_result (*yetty_yetty_ypaint_canvas_scroll_callback)(
...
typedef struct yetty_ycore_void_result (*yetty_yetty_ypaint_canvas_cursor_set_callback)(
...
struct yetty_ycore_void_result yetty_yetty_ypaint_canvas_clear(struct yetty_yetty_ypaint_canvas *canvas);

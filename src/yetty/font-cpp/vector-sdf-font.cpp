...
public:
    ...
    Result<void> init() override {
        ...
        ydebug("VectorSdfFont loaded: {} (units_per_EM={} ascender={:.1f} descender={:.1f} advance={:.1f})",
...
private:
    ...
    Result<void> uploadToGPU() {
        ...
        bufDesc.label = WGPU_STR("VectorSdfFont Glyph Buffer");
        ...
        ydebug("VectorSdfFont uploaded: {} glyphs, {} curves, {} bytes",
...
//=============================================================================
// VectorSdfFont::createImpl - ObjectFactory entry point
//=============================================================================

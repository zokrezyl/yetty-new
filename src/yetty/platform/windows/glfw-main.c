/* glfw-main.c - Application entry point for Windows */
...
static unsigned __stdcall render_thread_func(void *arg)
{
...
int main(int argc, char **argv)
{
    ...
    HANDLE render_thread = (HANDLE)_beginthreadex(NULL, 0, render_thread_func, &thread_args, 0, NULL);

// local_id 0x002a — dvd-bounce

fn dvdBounce_mod(x: f32, y: f32) -> f32 {
    return x - y * floor(x / y);
}

fn shader_glyph_42(local_uv: vec2<f32>, time: f32, fg: vec3<f32>, bg: vec3<f32>, pixel_pos: vec2<f32>) -> vec3<f32> {
    let margin = 0.12;

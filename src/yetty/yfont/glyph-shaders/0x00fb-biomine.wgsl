...
fn shader_glyph_251(local_uv: vec2<f32>, time: f32, fg: vec3<f32>, bg: vec3<f32>, pixel_pos: vec2<f32>) -> vec3<f32> {
    ...
    let uv = (pixel_pos - screenSize * 0.5) / screenSize.y;

// local_id 0x00fa — minkowski-tube
...
fn shader_glyph_250(local_uv: vec2<f32>, time: f32, fg: vec3<f32>, bg: vec3<f32>, pixel_pos: vec2<f32>) -> vec3<f32> {
    ...
    var uv = (pixel_pos - screenSize * 0.5) / screenSize.y +
